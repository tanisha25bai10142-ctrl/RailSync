...
## 4. Technologies & Java Concepts Used
...
![Figure 5.1: RailSync Layered System Architecture](screenshots/diagram_architecture.png)

---

### 5.2 Train Search Flowchart
...
![Figure 5.2: Train Route Search Workflow](screenshots/diagram_search.png)

---

### 5.3 Ticket Booking Flowchart
...
![Figure 5.3: Ticket Booking & Tiered Allocation Flowchart](screenshots/diagram_booking.png)

---

### 5.4 Ticket Cancellation & Promotion Cascade Flowchart
...
![Figure 5.4: Cancellation & Queue Cascade Workflow](screenshots/diagram_cancellation.png)
...
## 7. Implementation Details & OOP Concepts

### 7.1 Abstraction and Inheritance
...
### 9.4 Ticket Booking & Seat Allocation
...
### 9.6 Ticket Cancellation & Refund Receipt
...
### 9.7 RAC and Waiting List Queue Status
...
### 9.8 Dynamic Fare & Concession Calculation
...
### 9.9 Swing Graphical User Interface (Passenger Portal)
...
### 9.10 Swing Graphical User Interface (Admin Console)
...
### 9.11 Exported Electronic Reservation Slip
